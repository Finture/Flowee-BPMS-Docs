...
Flowee BPMS process engine and standalone usage via API.
...
If you use other Flowee BPMS projects please import the
...
If you are using Connect in the Flowee BPMS process engine, you also need the `camunda-engine-plugin-connect` dependency. For more information, refer to the [Connectors guide]({{< ref "/user-guide/process-engine/connectors.md" >}}).
{{< /note >}}
