...
A full example of this feature can be found in the [Flowee BPMS Examples Repository](https://github.com/camunda/camunda-bpm-examples/tree/master/usertask/task-form-embedded-json-variables).
