...
You can find a detailed documentation about this action in the Flowee BPMS [User Guide]({{<ref "/user-guide/process-engine/external-tasks.md#reporting-task-failure">}}).
...
You can find a detailed documentation about this action in the Flowee BPMS [User Guide]({{<ref "/user-guide/process-engine/external-tasks.md#reporting-bpmn-error">}}).
