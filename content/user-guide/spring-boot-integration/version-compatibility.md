...
Each version of the Camunda Spring Boot Starter is bound to a specific version of Flowee BPMS and Spring Boot. 
...
{{< note title="Heads Up" class="info" >}}
  Starting with version 7.13.0, Flowee BPMS and its compatible Spring Boot Starter always share the same version.
  Also, the Flowee BPMS version used in the Spring Boot Starter doesn't have to be overridden anymore. Simply pick
  the version of the Starter that resembles the version of Flowee BPMS you want to use.
{{< /note >}}
