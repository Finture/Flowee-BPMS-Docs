...
menu:
  main:
    ...
    pre: "Only relevant for users coming from Flowee BPMS version <= 7.12.0"

---

If you come from a Flowee BPMS version <= 7.12.x and already use FEEL, it might be that you need to 
...
* To see how this legacy behavior can be enabled again in Flowee BPMS, please see the
