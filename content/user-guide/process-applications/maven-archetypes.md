...
They enable a quickstart for developing production-ready process applications using Flowee BPMS.
...
<table class="table table-bordered">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Process application that uses a shared Flowee BPMS engine in a Java EE Container, e.g., Wildfly.
    ...
    <tr>
      ...
      <td>Process application that uses a shared Flowee BPMS engine in a Servlet Container, e.g., Apache Tomcat.
