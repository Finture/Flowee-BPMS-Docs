...
Flowee BPMS provides advanced integration for Wildfly in the form of a custom [Wildfly Subsystem](https://docs.wildfly.org/23/Extending_WildFly.html).
...
* Use a managed Thread Pool for the Job Executor configured through the Flowee BPMS Subsystem.

# Configure the Job Executor in standalone.xml/domain.xml

Since Flowee BPMS.5, the configuration of the thread pool used by the Job Executor is done in the Camunda subsystem, not in the JBoss Threads subsystem, as it was done before 7.5.  
