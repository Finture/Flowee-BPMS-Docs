...
In order to easily construct typed values, Flowee BPMS offers the class `org.camunda.bpm.engine.variable.Variables`. This class contains static methods that allow creation of single typed values as well as creation of a map of typed values in a fluent way.
...
To improve the reusability of source code and business logic, Flowee BPMS offers input/output
