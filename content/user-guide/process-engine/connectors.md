...
* `camunda-engine-plugin-connect`: a process engine plugin to add Connect to Flowee BPMS.
...
{{< note title="" class="info" >}}
  When using a pre-built distribution of Flowee BPMS, the plugin is already pre-configured.
{{< /note >}}
