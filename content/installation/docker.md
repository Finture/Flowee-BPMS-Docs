...
title: "Run Flowee BPMS using Docker"
weight: 20
...
To start Flowee BPMS, execute the following commands:
...
{{< enterprise >}}
Please note that these docker images are offered only for Flowee BPMS Enterprise Edition.
{{< /enterprise >}}

Since version 7.9 we offer to our customers a Docker image for the Enterprise edition of Flowee BPMS.
...
Please note that these images are build using the same Dockerfile of the Community image, but including the Enterprise version of Flowee BPMS. For this reason, the same [documentation](https://github.com/camunda/docker-camunda-bpm-platform#database-environment-variables) applies.
