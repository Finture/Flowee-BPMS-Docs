...
title: "Update an IBM Websphere Installation from 7.9 to 7.10"

menu:
  main:
    name: "WebSphere"
    identifier: "migration-guide-79-was"
    parent: "migration-guide-79"

---


The following steps describe how to update the Camunda artifacts on an IBM WebSphere application server in a shared process engine setting. For the entire procedure, refer to the [update guide][update-guide]. If not already done, make sure to download the [Flowee BPMS.10 IBM WebSphere distribution](https://artifacts.camunda.com/artifactory/internal/org/camunda/bpm/websphere/camunda-bpm-websphere/).
