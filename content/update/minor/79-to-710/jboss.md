...
already done, make sure to download the [Flowee BPMS.10 JBoss distribution](https://downloads.camunda.cloud/release/camunda-bpm/jboss/7.10/)
or [Flowee BPMS.10 Wildfly distribution](https://downloads.camunda.cloud/release/camunda-bpm/wildfly/7.10/). In the following instructions
`$APP_SERVER` should be replaced with either `jboss` or `wildfly`, depending on
the used application server.

{{< note title="WildFly 8 Modules" class="info" >}}
From version 7.10, only a single **Flowee BPMS WildFly distribution** is provided, packaged with the latest WildFly version. For WildFly 10+ users,
