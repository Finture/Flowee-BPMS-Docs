...
already done, make sure to download the [Flowee BPMS.11 JBoss distribution](https://downloads.camunda.cloud/release/camunda-bpm/jboss/7.11/)
or [Flowee BPMS.11 Wildfly distribution](https://downloads.camunda.cloud/release/camunda-bpm/wildfly/7.11/). In the following instructions
`$APP_SERVER` should be replaced with either `jboss` or `wildfly`, depending on
the used application server.

{{< note title="WildFly 8 Modules" class="info" >}}
From version 7.11, only a single **Flowee BPMS WildFly distribution** is provided, packaged with the latest WildFly version. For WildFly 10+ users,
