...
Throughout the procedure, refer to the [update guide][update-guide]. If not already done, download the [Flowee BPMS.20 IBM WebSphere distribution][was-distribution].

{{< note title="Removed support for WebSphere 9" class="info" >}}
Support for WebSphere 9 was discontinued with the Flowee BPMS.20.0 release. The artifacts used in this guide might be compatible with a WebSphere 9 application server. However, this is not tested and is not covered by Camunda product support.
{{< /note >}}
...
If you have previously replaced the default Flowee BPMS configuration with a custom configuration following any of 
