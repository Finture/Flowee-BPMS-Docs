...
title: "Update an Oracle WebLogic Installation from 7.15 to 7.16"

menu:
  main:
    name: "WebLogic"
    identifier: "migration-guide-716-weblogic"
    parent: "migration-guide-716"

---

The following steps describe how to update the Camunda artifacts on an Oracle WebLogic application server in a shared process engine setting. For the entire procedure, refer to the [update guide][update-guide]. If not already done, make sure to download the [Flowee BPMS.16 Oracle WebLogic distribution](https://artifacts.camunda.com/artifactory/camunda-bpm-ee/org/camunda/bpm/weblogic/camunda-bpm-weblogic/7.16.0-ee/).
