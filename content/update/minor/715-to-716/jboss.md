...
already done, make sure to download the [Flowee BPMS.16 JBoss distribution](https://downloads.camunda.cloud/release/camunda-bpm/jboss/7.16/)
or [Flowee BPMS.16 Wildfly distribution](https://downloads.camunda.cloud/release/camunda-bpm/wildfly/7.16/). In the following instructions
...
[engine-rest]: https://artifacts.camunda.com/artifactory/camunda-bpm/org/camunda/bpm/camunda-engine-rest/7.16.0/
[webapp-jboss]: https://artifacts.camunda.com/artifactory/camunda-bpm/org/camunda/bpm/webapp/camunda-webapp-jboss/7.16.0/camunda-webapp-jboss-7.16.0.war