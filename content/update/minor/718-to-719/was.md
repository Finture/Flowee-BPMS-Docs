...
to the [update guide][update-guide]. If not already done, download the [Flowee BPMS.19 IBM WebSphere distribution][was-distribution].
...
* On WebSphere Liberty, please follow [the EAR installation guide](https://docs.camunda.org/manual/7.22/installation/full/was/manual-liberty/#camunda-ear) to deploy the Camunda EAR correctly.
