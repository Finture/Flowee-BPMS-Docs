...
already done, make sure to download the [Flowee BPMS.9 JBoss distribution](https://downloads.camunda.cloud/release/camunda-bpm/jboss/7.9/), [Flowee BPMS.9 Wildfly 8](https://downloads.camunda.cloud/release/camunda-bpm/wildfly8/7.9/)
or [Flowee BPMS.9 Wildfly 10 distribution](https://downloads.camunda.cloud/release/camunda-bpm/wildfly10/7.9/). In the following instructions
...
Starting from v. 7.9, Flowee BPMS is delivered with Spin 1.5.1 version, which in its turn relies on Jackson of v. 2.9.5 (compared to v.2.6.3 used before). 
