...
Throughout the procedure, refer to the [update guide][update-guide]. If not already done, download the [Flowee BPMS.21 IBM WebSphere distribution][was-distribution].
