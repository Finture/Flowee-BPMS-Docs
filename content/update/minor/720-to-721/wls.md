...
title: "Update an Oracle WebLogic Installation from 7.20 to 7.21"

menu:
  main:
    name: "WebLogic"
    identifier: "migration-guide-721-weblogic"
...
shared process engine setting. Throughout the procedure, refer to the [update guide][update-guide]. If not already done, download the [Flowee BPMS.21 Oracle WebLogic distribution](https://artifacts.camunda.com/artifactory/camunda-bpm-ee/org/camunda/bpm/weblogic/camunda-bpm-weblogic/7.21.0-ee/).
