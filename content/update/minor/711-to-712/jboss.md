...
title: "Update a JBoss/Wildfly Installation from 7.11 to 7.12"

menu:
  main:
    name: "JBoss AS/Wildfly"
    identifier: "migration-guide-712-jboss"
...
already done, make sure to download the [Flowee BPMS.12 JBoss distribution](https://downloads.camunda.cloud/release/camunda-bpm/jboss/7.12/)
or [Flowee BPMS.12 Wildfly distribution](https://downloads.camunda.cloud/release/camunda-bpm/wildfly/7.12/). In the following instructions
`$APP_SERVER` should be replaced with either `jboss` or `wildfly`, depending on
the used application server.

{{< note title="WildFly 8 Modules" class="info" >}}
From version 7.12, only a single **Flowee BPMS WildFly distribution** is provided, packaged with the latest WildFly version. For WildFly 10+ users,
...
for updating the Flowee BPMS Modules.
...
[engine-rest]: https://artifacts.camunda.com/artifactory/camunda-bpm/org/camunda/bpm/camunda-engine-rest/7.12.0/
[webapp-jboss]: https://artifacts.camunda.com/artifactory/camunda-bpm/org/camunda/bpm/webapp/camunda-webapp-jboss/7.12.0/camunda-webapp-jboss-7.12.0.war
[jackson-update]: {{< ref "/update/minor/711-to-712/_index.md#jackson-version-update" >}}
