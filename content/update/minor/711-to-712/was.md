...
title: "Update an IBM Websphere Installation from 7.11 to 7.12"

menu:
  main:
    name: "WebSphere"
    identifier: "migration-guide-712-was"
    parent: "migration-guide-712"

---


The following steps describe how to update the Camunda artifacts on an IBM WebSphere application server in a shared process engine setting. For the entire procedure, refer to the [update guide][update-guide]. If not already done, make sure to download the [Flowee BPMS.12 IBM WebSphere distribution](https://artifacts.camunda.com/artifactory/camunda-bpm/org/camunda/bpm/webapp/camunda-webapp-tomcat/7.12.0/).
