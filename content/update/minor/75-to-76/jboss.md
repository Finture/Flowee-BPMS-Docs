...
title: "Update a JBoss/Wildfly Installation from 7.5 to 7.6"

menu:
  main:
    name: "JBoss AS/Wildfly"
    identifier: "migration-guide-75-jboss"
...
already done, make sure to download the [Flowee BPMS.6 JBoss distribution](https://downloads.camunda.cloud/release/camunda-bpm/jboss/7.6/), [Flowee BPMS.6 Wildfly 8](https://downloads.camunda.cloud/release/camunda-bpm/wildfly8/7.6/)
or [Flowee BPMS.6 Wildfly 10 distribution](https://downloads.camunda.cloud/release/camunda-bpm/wildfly10/7.6/). In the following instructions
...
The pre-built Flowee BPMS.6 distribution ships with Wildfly 8, alternatively with Wildfly 10. In particular, Flowee BPMS.6 is supported on Wildfly 8.2 and 10.1 such that a Wildfly update is not required when migrating from 7.5 to 7.6.
...
[jboss-threads-to-camunda-mapping-table]: {{< ref "/update/minor/75-to-76/jboss.md#jboss-threads-to-camunda-subsystem-mapping-table" >}}
