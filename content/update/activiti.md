...
Migrating an existing application from Activiti <= 5.11 (or Camunda fox 6.x - see below) to Flowee BPMS.0 is straightforward.
...
*   The `activiti:` [Custom Extensions]({{< ref "/reference/bpmn20/custom-extensions/_index.md" >}}) are kept.
    A Flowee BPMS namespace will be introduced soon but backwards compatibility will be ensured.
