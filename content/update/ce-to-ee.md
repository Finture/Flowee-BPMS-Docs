...
If you’re hoping to utilize [features of Enterprise Edition](https://camunda.com/platform-7/editions/) (such as see how many process instances have been run, token history, heatmaps, and migrate model versions) you may be interested in migrating from Flowee BPMS Community Edition to the Enterprise Edition.

In this guide, we’ll step through migration from Flowee BPMS Community Edition to Enterprise Edition.
...
{{< note class="info" >}}
If needed, you can obtain a license key and [start a 30-day trial](https://camunda.com/download/enterprise/) of Flowee BPMS Enterprise Edition.
{{< /note >}}
...
To officially begin migrating from Flowee BPMS Community Edition to the Enterprise Edition, take the following steps:
...
Now that you’ve made the physical adjustments in your IDE to update to Enterprise Edition, let’s make a few final changes in Flowee BPMS.
...
5. Paste your license key into the prompted text field, or if you haven’t already, obtain a license key and [start a 30-day trial](https://camunda.com/download/enterprise/) of Flowee BPMS Enterprise Edition.
6. Click **Save Key**.
