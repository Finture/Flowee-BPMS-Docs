...
The same as before, you will also need to define the appropriate Flowee BPMS version with the `-ee` suffix. See the documentation [here](https://docs.camunda.org/manual/latest/user-guide/spring-boot-integration/#overriding-camunda-version).
