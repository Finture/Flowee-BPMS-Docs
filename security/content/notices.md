...
On this page, Finture publishes security notices _after_ fixes are available.
...
The version of wildfly-dist shipped with Flowee BPMS was affected by the following vulnerabilities:
cpe:2.3:a:clustering_project:clustering:7.0.8:*:*:*:*:*:*:*
cpe:2.3:a:infinispan:infinispan:7.0.8:*:*:*:*:*:*:*
cpe:2.3:a:redhat:wildfly:7.0.8:*:*:*:*:*:*:*
cpe:2.3:a:wildfly:wildfly:7.0.8:*:*:*:*:*:*:*

The version of spring-web shipped with Flowee BPMS was affected by the following vulnerabilities:
cpe:2.3:a:pivotal_software:spring_framework:5.3.39:*:*:*:*:*:*:*
cpe:2.3:a:springsource:spring_framework:5.3.39:*:*:*:*:*:*:*
cpe:2.3:a:vmware:spring_framework:5.3.39:*:*:*:*:*:*:*
cpe:2.3:a:web_project:web:5.3.39:*:*:*:*:*:*:*

The version of jruby-complete shipped with Flowee BPMS was affected by the following vulnerabilities:
cpe:2.3:a:snakeyaml_project:snakeyaml:1.18:*:*:*:*:*:*:*

**How to determine if the installation is affected**

Flowee BPMS 1.0.0 or lower is used

**Solution**

Finture has provided 1.0.1 releases for Flowee BPMS which contain fixes for the above-mentioned CVEs.
...
- The Flowee BPMS Docker containers are used.
...
The version of the PostgreSQL JDBC driver used in the Flowee BPMS 7 Docker images had a vulnerability:
...
- Flowee BPMS Tomcat is used or Flowee BPMS Run is used or Flowee BPMS Spring Boot Starter is used.
- See the NIST links above for detailed descriptions of the circumstances required to exploit the vulnerabilities.
...
The version of Swagger UI included in Flowee BPMS Run had a number of third-party library vulnerabilities:
...
- Flowee BPMS Tomcat is used *or* Flowee BPMS Run is used *or* Flowee BPMS Spring Boot Starter *or* Camunda RPA Bridge is used
- See the NIST links above for detailed descriptions of the circumstances required to exploit the vulnerabilities
...
The version of Scala shipped with the FEEL engine in Flowee BPMS 7 was vulnerable to an object deserialization flaw. Details:
...
* Flowee BPMS 7.18.0, 7.17.6, 7.16.13, and 7.15.19
...
* Flowee BPMS 7.18.0-alpha4 and 7.17.3
...
The Docker images for Flowee BPMS 7 contained system libraries with reported vulnerabilities.
...
* Flowee BPMS 7.18.0-alpha4, 7.17.3, 7.16.10, and 7.15.16
...
The version of Jackson included in Flowee BPMS 7 was vulnerable to denial of service attacks. Details:
...
The version of Groovy included in the Flowee BPMS 7 Run, Tomcat, Weblogic,  Websphere, Wildfly distributions had a local privilege escalation vulnerability. Details:

- https://nvd.nist.gov/vuln/detail/CVE-2021-20289

**How to determine if the installation is affected**

- One of the Flowee BPMS 7 Run, Tomcat, Weblogic,  Websphere, Wildfly distributions is used
...
The version of Resteasy used by the Flowee BPMS 7 REST API and web applications had an information disclosure vulnerability. Details:

- https://nvd.nist.gov/vuln/detail/CVE-2021-20289

**How to determine if the installation is affected**

- The Flowee BPMS 7 Tomcat distribution is used
...
The version of the MySQL JDBC connector included in the Flowee BPMS 7 Docker images had two known vulnerabilities. Details:
...
- The Flowee BPMS 7 Docker containers are used
- MySQL is used for the database connection
...
- Flowee BPMS 7 is not directly affected by this vulnerability (see our [forum announcement](https://forum.camunda.io/t/spring-remote-code-execution-rce-vulnerability-spring4shell/33848)). We are making this announcement due to the high popularity of the vulnerability.
...
The version of the Spring Framework used in Flowee BPMS 7 was vulnerable to log entry insertion:
...
* Flowee BPMS 7.17.0, 7.16.6, 7.15.12, and 7.14.18
* RPA Bridge 1.1.6
...
The version of the PostgreSQL JDBC driver used in the Flowee BPMS 7 Docker images had multiple vulnerabilities:
...
* Flowee BPMS 7.17.0-alpha5, 7.16.7, 7.15.13, and 7.14.19
...
* Flowee BPMS 7.17.0-alpha6, 7.16.7, 7.15.13, and 7.14.19
...
* Flowee BPMS 7.17.0-alpha5, 7.16.6, 7.15.12, and 7.14.18
...
The version of Jackson used by Flowee BPMS 7 was vulnerable to Denial of Service attacks.

**How to determine if the installation is affected**

* You use the Flowee BPMS 7 REST API
...
When connected to LDAP, Flowee BPMS Run logged sensitive LDAP connection configuration options during startup.

**How to determine if the installation is affected**

* You use Flowee BPMS Run
* You connect Flowee BPMS Run to LDAP for user management
...
* Flowee BPMS 7.17.0-alpha4, 7.16.5, 7.15.11, and 7.14.17
...
* Flowee BPMS 7.17.0-alpha3, 7.16.5, 7.15.11, and 7.14.17
...
* Flowee BPMS Runtime 7.17.0-alpha3, 7.16.3, 7.15.9, and 7.14.15
...
- Flowee BPMS Tomcat is used *or* Flowee BPMS Run is used *or* Flowee BPMS Spring Boot Starter is used *or* Camunda RPA Bridge is used
- See the NIST links above for detailed descriptions of the circumstances required to exploit the vulnerabilities
...
- The Flowee BPMS web applications are used (Cockpit, Tasklist, Admin)
...
- The Flowee BPMS web applications are used
...
The version of the MySQL JDBC driver used by the Flowee BPMS Docker container was vulnerable to various attacks. Details:
...
- The Flowee BPMS Docker container is used
- MySQL is used
...
- You are using the Flowee BPMS REST API or web applications
...
- You are using the Flowee BPMS process engine
...
- Flowee BPMS is used with enabled authorization check and enabled variable-specific permissions (configuration flag `enforceSpecificVariablePermission` set to `true`)
...
- Flowee BPMS Tomcat is used *or* Flowee BPMS Spring Boot Starter is used
...
Camunda Optimize is a product module that uses a separate REST API to fetch data from the Flowee BPMS runtime platform for export. Using this API, it was possible for a user to access history data of tenants they are not permitted to access.
...
Flowee BPMS and Spring Boot Starter
...
- The Flowee BPMS web applications (Cockpit, Tasklist, Admin) are used
...
The version of Tomcat used by the Flowee BPMS Tomcat distribution is subject to various vulnerabilities. Details:
...
- The Flowee BPMS Tomcat distribution is used
...
In some cases of server-side exceptions in the Camunda REST API and Flowee BPMS web applications, a stacktrace could be disclosed to the client. This allows an attacker to gain insights about the structure and source code of server-side components.
...
The version of dmn-js used by Flowee BPMS was vulnerable to HTML Injection / Cross-site scripting flaws. Details:
...
- Flowee BPMS 7.12.0-alpha1, 7.11.1, 7.10.7, 7.9.13
...
Flowee BPMS Spring Boot Starter
...
- Flowee BPMS enterprise edition is used
...
The Flowee BPMS has obtained security fixes related to the prevention of CSRF attacks, and support for providing _whitelist patterns_ for User, Group and Tenant IDs.
...
Camunda support is alerting customers to a potential risk with the Flowee BPMS product. A vulnerability exists that can possibly allow an attacker to perform remote execution of code.
