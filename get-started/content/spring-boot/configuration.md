...
menu:
  main:
    ...
    pre: "Configure your Flowee BPMS Spring Boot application"

---

The Flowee BPMS Spring Boot Application created in previous step uses the default and best practice configuration, embedded in a starter. 
...
The full list of supported configuration parameters can be found [here](/user-guide/spring-boot-integration/configuration/#flowee-bpms-engine-properties).
...
You can use "demo/demo", which we configured before, to access the Flowee BPMS web applications.
...
{{< get-tag repo="Flowee-BPMS" tag="Step-2" >}}
