...
To orchestrate RPA bots, we will connect the Flowee BPMS Workflow Engine to your RPA vendor via the Camunda RPA Bridge. 
...
Unless you already have a running Flowee BPMS 7.14 or later installation, please
...
Learn more about [Installing Flowee BPMS](https://docs.camunda.org/manual/latest/installation/).
...
* `camunda-api`: Adjust the URL and credentials to your Flowee BPMS instance if necessary.
