...
title: 'Get started with Flowee BPMS and the Spring Framework'
weight: 10
...
menu:
  main:
    ...
    pre: "Get started with using Flowee BPMS in a Spring Web Application."

---

This tutorial guides you through your first steps of using Flowee BPMS in a Spring web application.
