...
menu:
  main:
    ...
    pre: "Deploy the Process to Flowee BPMS and start your first process instance."
...
BPMN diagrams must be created for the process engine they intend to be deployed on. {{< /note >}}
...
In Flowee BPMS, there are different ways to start a new process instance.
You can leverage the Flowee BPMS REST API to start a new process instance by sending a POST Request.
